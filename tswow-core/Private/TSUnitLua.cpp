...
void TSLua::load_unit_methods(sol::state& state)
{
    ...
    LUA_FIELD(ts_unit, TSUnit, CanReachWithMeleeAutoAttack);
    LUA_FIELD(ts_unit, TSUnit, UpdateAllStats);
    ...
    LUA_FIELD(ts_unit, TSUnit, SetVisible);
    ...
    LUA_FIELD(ts_unit, TSUnit, MoveSplineTo);
    ...
    LUA_FIELD(ts_unit, TSUnit, SendBroadcastTextSay);
    LUA_FIELD(ts_unit, TSUnit, SendBroadcastTextEmote);
    LUA_FIELD(ts_unit, TSUnit, SendUnitYell);
    LUA_FIELD(ts_unit, TSUnit, SendBroadcastTextYell);
    LUA_FIELD(ts_unit, TSUnit, SendUnitSayToZone);
    LUA_FIELD(ts_unit, TSUnit, SendUnitYellToZone);
    LUA_FIELD(ts_unit, TSUnit, DeMorph);
    LUA_FIELD(ts_unit, TSUnit, ClearInCombat);
    LUA_FIELD(ts_unit, TSUnit, CombatStop);
    LUA_FIELD(ts_unit, TSUnit, StopSpellCast);
    LUA_FIELD(ts_unit, TSUnit, InterruptSpell);
    LUA_FIELD(ts_unit, TSUnit, IsNonMeleeSpellCast);
    LUA_FIELD(ts_unit, TSUnit, InterruptNonMeleeSpells);
